...
def build_rq2_json(
    ...
    return {
        ...
        "hypothesis": {
            ...
            "note": (
                "Point estimates are reported here. Formal hypothesis testing is "
                "generated by src.statistics (Phase 2)."
            ),
        },
...
def build_rq2_markdown(
    ...
    lines.extend(
        [
            ...
            "",
            "Formal statistical comparison of paired predictions will be reported in "
            "`results/statistical_tests/` after running:",
            "",
            "```bash",
            "python -m src.statistics",
            "```",
            "",
            "Until then, use the tables above for descriptive comparison of precision, "
            "recall, and F1-score across NB, SVM, and MLR.",
            "",
            "## Source Files",
            "",
